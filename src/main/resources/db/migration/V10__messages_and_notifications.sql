...
CREATE TABLE `user_messages` (
    ...
    `is_archived`    TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=未归档 1=已归档',
    `archived_at`    DATETIME        NULL DEFAULT NULL COMMENT '归档时间',
    `is_important`   TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '1=重要消息',
...
CREATE TABLE `notification_delivery_logs` (
    ...
    `status`             TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=待投递 1=已投递 2=失败 3=已读（push专用）',
