...
CREATE TABLE `roles` (
    ...
    `level`            TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=系统 1=学生 2=教师 3=辅导员 4=系主任 5=院长 6=校长 7+=自定义',
    `role_type`        TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=教学类 2=行政类 3=审核类 4=系统管理类',
...
CREATE TABLE `permissions` (
    ...
    `type`             TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=menu菜单 2=button按钮 3=api接口',
