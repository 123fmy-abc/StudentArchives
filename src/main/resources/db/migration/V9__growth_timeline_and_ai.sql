...
CREATE TABLE `growth_timelines` (
    ...
    `event_type`       TINYINT UNSIGNED NOT NULL COMMENT '1=奖项 2=成绩 3=实践 4=职业规划 5=短板改进 6=能力提升',
    ...
    `status`           TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=草稿 1=待审核 2=已通过 3=已退回 4=已撤销',
...
CREATE TABLE `ai_generation_logs` (
    ...
    `token_usage`        INT UNSIGNED    NULL DEFAULT NULL COMMENT 'Token 消耗量',
    `generation_time_ms` INT UNSIGNED    NULL DEFAULT NULL COMMENT '生成耗时（毫秒）',
    `call_status`        TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '0=失败 1=成功 2=重试',
...
CREATE TABLE `ai_teacher_feedbacks` (
    ...
    `action`            TINYINT UNSIGNED NOT NULL COMMENT '1=采纳 2=修改后采纳 3=拒绝',
